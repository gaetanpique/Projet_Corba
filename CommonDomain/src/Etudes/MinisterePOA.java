        ...
        implements MinistereOperations, org.omg.CORBA.portable.InvokeHandler
{
            ...
            final org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        if (opName.equals("dereferencer")) {
                return _invoke_dereferencer(_is, handler);
        } else if (opName.equals("getListFormations")) {
        ...
        } else if (opName.equals("referencer")) {
                return _invoke_referencer(_is, handler);
        } else {
