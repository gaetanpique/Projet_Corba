    ...
    public boolean isInscrit()
    {
        while(true)
        {
            if (!this._is_local())
            {
                ...
                try
                {
                    org.omg.CORBA.portable.OutputStream _output = this._request("isInscrit",true);
                    _input = this._invoke(_output);
                    boolean _arg_ret = _input.read_boolean();
                    return _arg_ret;
                }
            ...
            {
                org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("isInscrit",_opsClass);
                if (_so == null)
                   continue;
                Etudes.EtudiantOperations _self = (Etudes.EtudiantOperations) _so.servant;
                try
                {
                    return _self.isInscrit();
                }
                finally
                {
                    _servant_postinvoke(_so);
    ...
    public boolean isMotDePasseCorrect(String motDePasse)
    {
        while(true)
        {
            if (!this._is_local())
            {
                ...
                try
                {
                    org.omg.CORBA.portable.OutputStream _output = this._request("isMotDePasseCorrect",true);
            ...
            {
                org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("isMotDePasseCorrect",_opsClass);
                if (_so == null)
                   continue;
                Etudes.EtudiantOperations _self = (Etudes.EtudiantOperations) _so.servant;
                try
                {
                    return _self.isMotDePasseCorrect( motDePasse);
                }
                finally
                {
                    _servant_postinvoke(_so);
