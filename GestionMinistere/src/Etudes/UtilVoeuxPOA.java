        ...
        implements UtilVoeuxOperations, org.omg.CORBA.portable.InvokeHandler
{
            ...
            final org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        if (opName.equals("getMeilleurePropositionByEtudiant")) {
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_soumettreVoeu(
        ...
        try
        {
            soumettreVoeu(arg0_in, arg1_in);

            _output = handler.createReply();

        }
        catch (Etudes.NombreMaxDeVoeuxAtteint _exception)
        {
            _output = handler.createExceptionReply();
            Etudes.NombreMaxDeVoeuxAtteintHelper.write(_output,_exception);
        }
        return _output;
    }
